                ...
                <div className='rcm-post-wrapper'>
                    <div className='rcm-post-container'> 
                        <div className='rcm-posts'>
                            <div className='rcm-posts'>
                                <div className='rcm-posts-left'>
                                    <span>1</span>
                                </div>
                                <div className='rcm-posts-right'>
                                    <div className='rcm-posts-content'>
                                        <div className='rcm-post-top'>
                                        <img src = {"https://1h3.googleusercontent.com/a/AATXAJwxW8p6OMkJf74hD-Y_LQYwbX_BZEE4Hb4YjOMa=s96-c"} alt="logo"/>
